...
namespace ClassLibraryLab2
{
    public abstract class ServerTcp
    {
        ...
        public int Port { get => port;set { if (!is_running) { if (!checkPort()) throw new Exception("zly port"); } else throw new Exception("nie mozna zmieniac portu kiedy serwer jest uruchomiony!"); } }
